...
class TekBSA286CL(GPIBObjectBaseClass):
    def __init__(self, addr=-3):
        GPIBObjectBaseClass.__init__(self, 'TEKTRONIX,BSA286CL',addr)
...
##        return float(self.instr.ask("GSM:SJitter:AMPUi?"))      
    ...
    def get_det_rate(self):
        return float(self.instr.ask("DET:DRAT?"))
    ...
    def set_min_Err_inject_16bit_interval(self):
        self.instr.write("GEN:EIET 16BITS") #Continuous Mode       
