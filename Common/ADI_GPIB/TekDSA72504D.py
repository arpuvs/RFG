...
class TekDSA72504D(GPIBObjectBaseClass):
    ...
    def DpoJet_Clear_State(self):
        self.instr.write('DPOJET:STATE CLEAR') #clears current DPOJET data
    ...
    def DpoJet_ReportName(self, filename):
        self.instr.write('DPOJET:REPORT:REPORTName %s' %filename) #Sets DPOJET report name

    def DpoJet_Report(self):
        self.instr.write('DPOJET:REPORT EXEC') #Saves DPOJET report in current configuration
    ...
    def Set_Chan1_Chan3_Math1(self, vterm, zoom='ON'):
        ...
        self.instr.write('SEL:CH1 OFF')  #Autosets scope measurements
        self.instr.write('SEL:CH3 OFF')  #Autosets scope measurements
        self.instr.write('SEL:MATH1 ON') #Turns the math measurmement on
        self.instr.write('CH1:VTERm:BIAS ' + str(vterm))
        self.instr.write('CH2:VTERm:BIAS ' + str(vterm))
        self.instr.write('CH3:VTERm:BIAS ' + str(vterm))
        self.instr.write('CH4:VTERm:BIAS ' + str(vterm))
